 ...
 */
class Version20180305131653 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, animateur_id INT NOT NULL, animateur_deux_id INT DEFAULT NULL, lieux_de_stage_id INT NOT NULL, numero_stage VARCHAR(255) NOT NULL, debut_de_stage DATE NOT NULL, fin_de_stage DATE NOT NULL, stage_hpo TINYINT(1) DEFAULT \'0\' NOT NULL, alert TINYINT(1) NOT NULL, INDEX IDX_C27C93697F05C301 (animateur_id), INDEX IDX_C27C93699DE4711C (animateur_deux_id), INDEX IDX_C27C936947D7ABBC (lieux_de_stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
