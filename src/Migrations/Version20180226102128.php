 ...
 */
class Version20180226102128 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE fonction (id INT AUTO_INCREMENT NOT NULL, fonction VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stagiaire_stage (id INT AUTO_INCREMENT NOT NULL, stagiaires_id INT DEFAULT NULL, stages_id INT DEFAULT NULL, cas_id INT DEFAULT NULL, bordereaux_id INT DEFAULT NULL, paye TINYINT(1) DEFAULT \'0\' NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, envoi_inscription TINYINT(1) DEFAULT NULL, envoi_convocation TINYINT(1) DEFAULT NULL, courrier TINYINT(1) DEFAULT NULL, email TINYINT(1) DEFAULT NULL, alerte TINYINT(1) DEFAULT NULL, bulletin_inscription TINYINT(1) DEFAULT NULL, cni TINYINT(1) DEFAULT NULL, copie_permis TINYINT(1) DEFAULT NULL, releve_integral TINYINT(1) DEFAULT NULL, decision_judiciaire TINYINT(1) DEFAULT NULL, n48 TINYINT(1) DEFAULT NULL, observations TINYINT(1) DEFAULT NULL, INDEX IDX_979FD2C5887A63F9 (stagiaires_id), INDEX IDX_979FD2C58E55E70A (stages_id), INDEX IDX_979FD2C57B7A91FA (cas_id), INDEX IDX_979FD2C5A1418383 (bordereaux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE infraction (id INT AUTO_INCREMENT NOT NULL, stagiaires_id INT DEFAULT NULL, tribunaux_id INT DEFAULT NULL, types_infractions_id INT DEFAULT NULL, heure TIME DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, date_infraction DATE DEFAULT NULL, date_tribunal DATE DEFAULT NULL, cs_permis VARCHAR(255) DEFAULT NULL, cs_assurance VARCHAR(255) DEFAULT NULL, INDEX IDX_C1A458F5887A63F9 (stagiaires_id), INDEX IDX_C1A458F55F989E13 (tribunaux_id), INDEX IDX_C1A458F5AF81BF54 (types_infractions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, animateur_id INT DEFAULT NULL, animateur_deux_id INT DEFAULT NULL, lieux_de_stage_id INT DEFAULT NULL, date_de_stage DATE NOT NULL, stage_hpo TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_C27C93697F05C301 (animateur_id), INDEX IDX_C27C93699DE4711C (animateur_deux_id), INDEX IDX_C27C936947D7ABBC (lieux_de_stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE permis (id INT AUTO_INCREMENT NOT NULL, stagiaires_id INT DEFAULT NULL, prefectures_id INT DEFAULT NULL, civilite VARCHAR(255) NOT NULL, nom VARCHAR(255) DEFAULT NULL, nom_epouse VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, numero_permis VARCHAR(255) DEFAULT NULL, delivre_le DATE DEFAULT NULL, UNIQUE INDEX UNIQ_17389453887A63F9 (stagiaires_id), UNIQUE INDEX UNIQ_17389453DA34113A (prefectures_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE animateur (id INT AUTO_INCREMENT NOT NULL, statut_id INT DEFAULT NULL, fonctions_id INT DEFAULT NULL, civilite VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, gta VARCHAR(255) DEFAULT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, numero_telephone_fixe INT DEFAULT NULL, numero_telephone_portable INT DEFAULT NULL, adresse_email VARCHAR(255) DEFAULT NULL, urssaf VARCHAR(255) DEFAULT NULL, siret INT DEFAULT NULL, forfait VARCHAR(255) DEFAULT NULL, km_ar INT DEFAULT NULL, repas VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2064DB2CF6203804 (statut_id), UNIQUE INDEX UNIQ_2064DB2CDC481574 (fonctions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prefecture (id INT AUTO_INCREMENT NOT NULL, permis_id INT DEFAULT NULL, prefecture VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_ABE6511A3594A24E (permis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cas (id INT AUTO_INCREMENT NOT NULL, cas VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tribunal (id INT AUTO_INCREMENT NOT NULL, tribunal VARCHAR(255) DEFAULT NULL, numero_parquet VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bordereau (id INT AUTO_INCREMENT NOT NULL, autorite VARCHAR(255) DEFAULT NULL, etablissement VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_adresse INT DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE animateur ADD CONSTRAINT FK_2064DB2CF6203804 FOREIGN KEY (statut_id) REFERENCES fonction (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE animateur DROP FOREIGN KEY FK_2064DB2CF6203804');
