 ...
 */
class Version20180223134018 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE animateur (id INT AUTO_INCREMENT NOT NULL, statut_id INT DEFAULT NULL, civilite VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, gta VARCHAR(255) DEFAULT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, numero_telephone_fixe INT DEFAULT NULL, numero_telephone_portable INT DEFAULT NULL, adresse_email VARCHAR(255) DEFAULT NULL, urssaf VARCHAR(255) DEFAULT NULL, siret INT DEFAULT NULL, forfait VARCHAR(255) DEFAULT NULL, km_ar INT DEFAULT NULL, repas VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2064DB2CF6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
