 ...
 */
class Version20180221130547 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE cas (id INT AUTO_INCREMENT NOT NULL, stagiaires_stages_id INT DEFAULT NULL, cas VARCHAR(255) DEFAULT NULL, INDEX IDX_3AD60BB558D120 (stagiaires_stages_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE infraction (id INT AUTO_INCREMENT NOT NULL, stagiaires_id INT DEFAULT NULL, types_infractions_id INT DEFAULT NULL, heure DATETIME DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, date_infraction DATE DEFAULT NULL, date_tribunal DATE DEFAULT NULL, cs_permis VARCHAR(255) DEFAULT NULL, cs_assurance VARCHAR(255) DEFAULT NULL, INDEX IDX_C1A458F5887A63F9 (stagiaires_id), INDEX IDX_C1A458F5AF81BF54 (types_infractions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, lieux_de_stage_id INT DEFAULT NULL, date_de_stage DATE DEFAULT NULL, animateur VARCHAR(255) DEFAULT NULL, animateur_deux VARCHAR(255) DEFAULT NULL, stage_hpo TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_C27C936947D7ABBC (lieux_de_stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
