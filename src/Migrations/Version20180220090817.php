 ...
 */
class Version20180220090817 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, genre VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, nom_epouse VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, lieu_de_naissance VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, numero_telephone_fixe INT DEFAULT NULL, numero_telephone_portable INT DEFAULT NULL, adresse_email VARCHAR(255) DEFAULT NULL, carte_avantage_jeunes TINYINT(1) DEFAULT \'0\' NOT NULL, partenaires TINYINT(1) DEFAULT \'0\' NOT NULL, adherents TINYINT(1) DEFAULT \'0\' NOT NULL, permis INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tribunal (id INT AUTO_INCREMENT NOT NULL, infractions_id INT NOT NULL, tribunal VARCHAR(255) DEFAULT NULL, date_tribunal DATE DEFAULT NULL, numero_parquet VARCHAR(255) DEFAULT NULL, INDEX IDX_DC8C3AAF34D1DE1A (infractions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
