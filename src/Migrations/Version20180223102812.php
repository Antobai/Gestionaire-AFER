 ...
 */
class Version20180223102812 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, lieux_de_stage_id INT DEFAULT NULL, date_de_stage DATE NOT NULL, animateur VARCHAR(255) DEFAULT NULL, animateur_deux VARCHAR(255) DEFAULT NULL, stage_hpo TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_C27C936947D7ABBC (lieux_de_stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
