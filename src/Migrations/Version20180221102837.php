 ...
 */
class Version20180221102837 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE animateur (id INT AUTO_INCREMENT NOT NULL, fonctions_id INT DEFAULT NULL, civilite VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, gta VARCHAR(255) DEFAULT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, numero_telephone_fixe INT DEFAULT NULL, numero_telephone_portable INT DEFAULT NULL, adresse_email VARCHAR(255) DEFAULT NULL, urssaf VARCHAR(255) DEFAULT NULL, siret INT DEFAULT NULL, forfait VARCHAR(255) DEFAULT NULL, km_ar INT DEFAULT NULL, repas VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2064DB2CDC481574 (fonctions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE infraction (id INT AUTO_INCREMENT NOT NULL, types_infractions_id INT DEFAULT NULL, heure TIME DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, date_infraction DATE DEFAULT NULL, date_tribunal DATE DEFAULT NULL, cs_permis VARCHAR(255) DEFAULT NULL, cs_assurance VARCHAR(255) DEFAULT NULL, INDEX IDX_C1A458F5AF81BF54 (types_infractions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage_lieux_de_stage (stage_id INT NOT NULL, lieux_de_stage_id INT NOT NULL, INDEX IDX_10E970E42298D193 (stage_id), INDEX IDX_10E970E447D7ABBC (lieux_de_stage_id), PRIMARY KEY(stage_id, lieux_de_stage_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE stage_lieux_de_stage ADD CONSTRAINT FK_10E970E42298D193 FOREIGN KEY (stage_id) REFERENCES stage (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE stage_lieux_de_stage ADD CONSTRAINT FK_10E970E447D7ABBC FOREIGN KEY (lieux_de_stage_id) REFERENCES lieux_de_stage (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE stage_lieux_de_stage DROP FOREIGN KEY FK_10E970E447D7ABBC');
        ...
        $this->addSql('ALTER TABLE stage_lieux_de_stage DROP FOREIGN KEY FK_10E970E42298D193');
        ...
        $this->addSql('DROP TABLE stage_lieux_de_stage');
