 ...
 */
class Version20180220150836 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE infraction (id INT AUTO_INCREMENT NOT NULL, types_infractions_id INT DEFAULT NULL, heure DATETIME DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, date_infraction DATE DEFAULT NULL, date_tribunal DATE DEFAULT NULL, cs_permis VARCHAR(255) DEFAULT NULL, cs_assurance VARCHAR(255) DEFAULT NULL, INDEX IDX_C1A458F5AF81BF54 (types_infractions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
